...
def Bike_control():
    ...
    dropped_vehicle.apply_control(carla.VehicleControl(steer = -0.35, throttle = 0.2))
    dropped_vehicle.VehicleLightState(carla.VehicleLightState(carla.VehicleLightState.Brake | carla.VehicleLightState.LeftBlinker | carla.VehicleLightState.LowBeam))
    time.sleep(2)
    dropped_vehicle.VehicleControl(carla.VehicleControl(throttle = 0.3))
    dropped_vehicle.VehicleLightState(carla.VehicleLightState(carla.VehicleLightState.HighBeam | carla.VehicleLightState.Brake))
    time.sleep(3)
    dropped_vehicle.apply_control(carla.VehicleControl(hand_brake = True))
